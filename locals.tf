locals {
  ...
  app_route_table_ids = [for k,v in lookup(lookup(module.subnets,"public",null),"route_table",null): v.id]
  db_route_table_ids = [for k,v in lookup(lookup(module.subnets,"public",null),"route_table",null): v.id]
